...
parser.add_argument(
    "--registry_name", type=str, default=None, help="The name of the wandb registry."
)
parser.add_argument(
    "--motion_file",
    type=str,
    default=None,
    help="Local path to the motion npz file (alternative to wandb registry).",
)
...
try:
    ...
    def dump_yaml(filename: str, data):
